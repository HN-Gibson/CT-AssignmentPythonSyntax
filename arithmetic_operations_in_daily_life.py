...
#assigned values to variables representing the cost of grocery
cost_bread = 4.99
cost_pb = 2.99
cost_jelly = 3.99

#assigned sum of ingredients to a variable to be printed
cost_pbj_ingredients = cost_bread + cost_pb + cost_jelly

#printed to show outcome
print (cost_pbj_ingredients)
...
#assigned values to variables based on the prompt
